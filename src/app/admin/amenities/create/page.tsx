          ...
          <div className="admin-form-card p-8 space-y-10">
            ...
            <div className="space-y-10">
              ...
              <div className="pt-10 border-t border-slate-100">
                <div className="flex items-center gap-5 bg-slate-50/50 p-6 rounded-[32px] border-2 border-slate-100 overflow-hidden group/sync hover:bg-white transition-all shadow-sm hover:border-blue-100 hover:shadow-xl">

      ...
      <div className="admin-page-header">
        <div className="flex items-center gap-6">
          ...
          <div className="min-w-0">
            ...
            <p className="admin-page-subtitle mt-1 text-slate-400">Add a new location to your destination directory</p>
          </div>
        </div>
        <div className="flex items-center gap-4">
          ...
          >
            <ShieldCheck size={20} /> {loading ? 'Saving...' : 'Save Destination'}
          </button>
        </div>
      </div>

    ...
    <div className="space-y-12 animate-in fade-in duration-1000">
      ...
      <div className="admin-page-header">
        <div>
          ...
          <p className="admin-page-subtitle mt-1 text-slate-400">Manage your customer testimonials and feedback.</p>
        </div>
                    ...
                    <td className="px-8 py-7">
                      <div className="flex items-center gap-5">
                        <div className="w-16 h-16 rounded-[24px] bg-slate-50 flex items-center justify-center text-slate-400 border border-slate-200/50 flex-shrink-0 group-hover:scale-125 group-hover:bg-amber-500 group-hover:text-white transition-all duration-700 shadow-sm overflow-hidden relative">
                           {item.image ? (
                               <img src={item.image} alt={item.name} className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-700 opacity-80 group-hover:opacity-100 scale-100 group-hover:scale-110" />
                           ) : (

...
import { Save, ArrowLeft, Type, Layout, AlignLeft, ShieldCheck, Globe, Clock, Briefcase, Hash, Zap } from 'lucide-react';
...
export default function CreateService() {
    ...
    const handleSubmit = async (e?: React.FormEvent) => {
        ...
        try {
            ...
            if (data.success) {
                toast.success('Service module deployed!');
            ...
            <div className="admin-page-header">
                <div className="flex items-center gap-6">
                    ...
                    <div className="min-w-0">
                        ...
                        <p className="admin-page-subtitle mt-1 text-slate-400">Add a new global service node to the platform</p>
                    </div>
                </div>
                <div className="flex items-center gap-4">
                    ...
                    >
                        <ShieldCheck size={20} /> {loading ? 'Deploying...' : 'Deploy Service'}
                    </button>
                </div>
            </div>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="p-6 bg-blue-50/50 rounded-3xl border border-blue-100/50">
                                ...
                                <p className="text-[10px] text-slate-500 font-medium leading-relaxed">
                                    Once deployed, the service will be visible to all users on the main services directory.
                                </p>
                            </div>
                        </div>
                    </div>

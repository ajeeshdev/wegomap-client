...
import { IndianRupee, MapPin, ArrowRight, Star, ChevronLeft, ChevronRight } from 'lucide-react';
            ...
            <div className="container mx-auto px-4 md:px-6">
                                ...
                                <div className="group relative bg-[#f1f5f9] rounded-[2.5rem] overflow-hidden border border-transparent hover:border-blue-100 transition-all duration-500 hover:shadow-[0_40px_80px_-20px_rgba(0,0,0,0.12)]">
                                    ...
                                    <div className="p-8">
                                        ...
                                        <div className="flex justify-between items-center group-hover:translate-x-1 transition-transform">
                                            ...
                                            <Link href={`/packages/${pkg._id}`} className="w-10 h-10 bg-white group-hover:bg-blue-600 group-hover:text-white rounded-full flex items-center justify-center shadow-lg transition-all border border-slate-100">
                ...
                <div>
                    <div className="flex flex-col md:flex-row justify-between items-end mb-16 px-4">
                        ...
                        <Link href="/packages" className="hidden md:flex items-center gap-2 font-black text-xs uppercase tracking-widest hover:text-blue-600 transition-colors group">
                        ...
                        {otherPackages.map((pkg: Package) => (
                            <div key={pkg._id} className="group flex flex-col items-center text-center">
                                <div className="aspect-square w-full bg-slate-100 rounded-[3rem] overflow-hidden mb-8 relative border border-slate-50 hover:border-blue-100 transition-all">
                                    ...
                                    <Link href={`/packages/${pkg._id}`} className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all transform scale-90 group-hover:scale-100">

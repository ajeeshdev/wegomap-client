...
export default function EditPage() {
 ...
 <p className="text-xs text-indigo-600 font-semibold uppercase tracking-wider">Editing: {formData.title}</p>
 </div>
 </div>
 ...
 disabled={saving}
 className="bg-indigo-600 hover:bg-black text-white px-8 py-3 rounded-2xl font-semibold flex items-center gap-2 transition-all shadow-xl shadow-indigo-500/20 active:scale-95 uppercase text-xs tracking-wider italic"
 >
 ...
 activeTab === tab.id
 ? 'bg-white shadow-xl shadow-slate-200/50 text-indigo-600 border-r-4 border-r-indigo-600'
 : 'text-slate-400 hover:text-slate-500 hover:bg-white/50'
 }`}
 >
 <Icon size={20} className={activeTab === tab.id ? 'text-indigo-600' : 'group-hover:text-slate-500 transition-colors'} />
 ...
 className="w-full bg-white/10 border border-white/10 rounded-xl px-4 py-2 text-xs font-bold outline-none focus:ring-2 focus:ring-indigo-500 transition-all appearance-none cursor-pointer"
 >
 ...
 className="w-full px-6 py-4 rounded-2xl border border-slate-100 bg-slate-50/50 focus:bg-white focus:ring-8 focus:ring-indigo-600/5 focus:border-indigo-600 transition-all font-bold text-slate-800 outline-none" 
 />
 </div>
 <div className="space-y-2">
 ...
 <a href={`/${formData.slug}`} target="_blank" className="text-indigo-500 hover:text-indigo-700 flex items-center gap-1 normal-case tracking-normal font-bold">
 ...
 className="w-full pl-10 pr-6 py-4 rounded-2xl border border-slate-100 bg-slate-50/50 focus:bg-white focus:ring-8 focus:ring-indigo-600/5 focus:border-indigo-600 transition-all font-mono text-xs text-slate-500 outline-none" 
 />
 </div>
 </div>
 </div>
 ...
 className="w-full px-6 py-4 rounded-2xl border border-slate-100 bg-slate-50/50 focus:bg-white focus:ring-8 focus:ring-indigo-600/5 focus:border-indigo-600 transition-all font-medium text-slate-800 outline-none" 
 ></textarea>
 </div>
 </div>
 )}
 ...
 className="w-full px-6 py-4 rounded-2xl border border-blue-100 bg-blue-50/10 focus:bg-white focus:ring-8 focus:ring-blue-500/5 focus:border-blue-500 transition-all font-bold text-slate-800 outline-none" 
 />
 </div>
 <div className="space-y-2">
 ...
 className="w-full px-6 py-4 rounded-2xl border border-blue-100 bg-blue-50/10 focus:bg-white focus:ring-8 focus:ring-blue-500/5 focus:border-blue-500 transition-all font-medium text-slate-800 outline-none" 
 ></textarea>
 </div>
 </div>
 ...
 <h4 className="text-blue-400 font-bold text-xl leading-tight mb-2">

    ...
    <div className="space-y-12 animate-in fade-in duration-1000">
      ...
      <div className="admin-form-grid">
            ...
            <div className="space-y-10">
              ...
              <div className="admin-form-group">
                <label className="admin-form-label flex items-center gap-2 mb-4">
                  <Terminal size={14} className="text-blue-600" /> JSON Content
                </label>
        ...
        <div className="admin-form-sidebar">
          <div className="admin-form-card p-6 space-y-8 sticky top-12">
            <div>
              ...
              <div className="admin-space-y-4">
                <div className="flex items-center gap-4 bg-slate-50 p-4 rounded-xl border border-slate-100 group">
                  <div className="w-8 h-8 rounded-lg bg-orange-100 flex items-center justify-center text-blue-600 shrink-0 group-hover:bg-blue-600 group-hover:text-white transition-all">
                    <ShieldCheck size={16} />
                  </div>
                  <div className="min-w-0">

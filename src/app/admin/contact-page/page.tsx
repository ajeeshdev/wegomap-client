...
import { Save, Info, Sparkles, MapPin, Phone, Mail, Clock } from 'lucide-react';
...
const DEFAULT_CONTENT: ContactPageContent = {
    banner: {
        title: "Contact Us",
        subtitle: "We'd love to hear from you. Feel free to reach out for bookings and inquiries.",
...
export default function ContactSettingsPage() {
    ...
    const [content, setContent] = useState<ContactPageContent>(DEFAULT_CONTENT);
    ...
    const fetchSettings = async () => {
        try {
            ...
            if (json.success && json.data) {
                const opt = json.data.find((o: { key: string }) => o.key === 'contact_page_settings');
                if (opt) {
                    try {
    ...
    const handleSave = async () => {
        ...
        try {
            const res = await fetch(`${API_URL}/options/bulk`, {
                ...
                body: JSON.stringify({
                    options: [
                        { key: 'contact_page_settings', value: JSON.stringify(content) }
                    ]
                })
            });
        ...
        <div className="space-y-10 animate-in fade-in duration-500 font-sans">
            <div className="admin-page-header">
                <div>
                    <h2 className="admin-page-title admin-page-title--section">
                        ...
                        Contact Page <span className="text-black">Configuration</span>
                    </h2>
                    <p className="admin-page-subtitle text-slate-500 font-bold">Manage the hero banner and header details for the contact page</p>
                </div>
            ...
            <div className="max-w-5xl mx-auto space-y-8">
                <div className="admin-form-card !p-8">
                    <div className="flex items-center gap-3 mb-8 border-b border-slate-50 pb-6">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-slate-400 font-bold">Hero section details for /contact</p>
                        </div>
                    </div>
                ...
                <div className="bg-amber-50 rounded-2xl p-6 border border-amber-100 flex gap-4">
                    ...
                    <div>
                        <h4 className="font-black text-amber-900 text-sm uppercase">Quick Tip</h4>
                        <p className="text-amber-800 text-xs font-bold leading-relaxed mt-1">
                            To update your contact details like Phone, Email, and Address, please use the <a href="/admin/site-options" className="underline decoration-2 underline-offset-2">General Settings</a> module. This page specifically handles the visual banner section.
                        </p>
                    </div>
                </div>
            </div>

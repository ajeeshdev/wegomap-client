                        ...
                        {showEnquire && (
                            <div className="pageBannerActions mt-8">
                                ...
                                <a
                                    ...
                                    className="bannerWhatsappBtn px-8 py-4 text-white font-bold rounded-2xl flex items-center gap-3 transition-all active:scale-95 text-sm uppercase tracking-widest"
                                >

            ...
            <div className="relative z-10 space-y-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-4">
                <div className="admin-form-group">
                  <label className="admin-form-label flex items-center gap-2">
                    <Ship size={12} className="text-blue-500" /> Houseboat Name
                  </label>
                  <input 
                    type="text" 
              ...
              <div className="admin-form-group pt-4 border-t border-slate-50">
                <label className="admin-form-label flex items-center gap-2 mb-6">
                  <Layers size={14} className="text-indigo-500" /> Description
                </label>
        ...
        <div className="admin-form-sidebar">
          <div className="admin-form-card p-6 space-y-8">
            ...
            <div className="space-y-6">
              <div className="admin-form-group">
                <label className="admin-form-label text-[10px] flex items-center gap-2"> <Tag size={10} className="text-blue-500" /> Category</label>
                <div className="relative">
                    <select 
              ...
              <div className="pt-4 border-t border-slate-50">
                <div className="flex items-center gap-3 bg-slate-50/50 p-4 rounded-2xl border border-slate-100 transition-all hover:bg-white hover:shadow-sm group/status">
                  <div className="w-10 h-10 rounded-xl bg-blue-100/50 flex items-center justify-center text-blue-600 shrink-0 group-hover/status:bg-blue-600 group-hover/status:text-white transition-all duration-500">

          ...
          <div className="admin-form-card space-y-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-4">
              <div className="admin-form-group">
                <label className="admin-form-label flex items-center gap-2"> <MapPin size={12} className="text-blue-600" /> Title</label>
                <input
                  type="text"
              ...
              <div className="admin-form-group md:col-span-2 pt-4 border-t border-slate-50">
                <label className="admin-form-label flex items-center gap-2 mb-4"> <Layers size={14} className="text-blue-600" /> Description</label>

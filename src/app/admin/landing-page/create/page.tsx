    ...
    <div className="property-edit-container animate-in fade-in duration-700">
      <div className="property-edit-header">
        <div className="header-left">
           <Link href="/admin/landing-page" className="p-3 bg-slate-50 border border-slate-100 rounded-full hover:bg-white hover:shadow-md transition-all text-slate-600"><ArrowLeft size={18} /></Link>
           <div>
              <h2 className="serif text-2xl font-bold leading-tight">{isEdit ? 'Update Landing Page' : 'New Campaign'}</h2>
              <p className="status-badge">CURRENT STATUS: <span className="active">{formData.status.toUpperCase()}</span></p>
           </div>
        </div>
      ...
      <div className="property-edit-layout">
                             ...
                             <div className="admin-form-group">
                               ...
                               <div className="relative">
                                 ...
                                 <input 
                                   ...
                                   className={`font-mono text-blue-600 ${formData.slug ? 'px-3' : 'pl-8'}`} 
                                 />
                               </div>
                             </div>
                          </div>
        ...
        <div className="meta-sidebar">
           <div className="meta-card">
              <div className="card-header"><h4 className="serif">Publishing Hub</h4></div>
              <div className="card-body space-y-6">
                 ...
                 {isEdit && (
                    <Link href={`/${formData.slug}`} target="_blank" className="mt-4 p-4 bg-slate-50 rounded-2xl border border-slate-100 flex items-center justify-center gap-3 text-[10px] font-black text-blue-600 hover:bg-white hover:shadow-sm transition-all uppercase tracking-widest group">
                       <Eye size={14} className="group-hover:scale-110 transition-transform" /> Live Simulation
                    </Link>
                 )}
                 ...
                 <div className="mt-6 p-4 bg-slate-50 rounded-2xl border border-slate-100 italic">
                    <div className="flex items-center gap-3 mb-2">
                       ...
                       <span className="text-[9px] font-black text-slate-400 uppercase tracking-widest">Temporal Index</span>
                    </div>
                    <div className="text-[10px] font-bold text-slate-500 leading-relaxed">
                       Last sync with global storefront: <span className="text-blue-600">{new Date().toLocaleDateString()}</span>
                    </div>
                 </div>
              </div>
           </div>
           ...
           <div className="meta-card">
              <div className="card-header"><h4 className="serif">Visual Identity</h4></div>
              <div className="card-body">
                 <ImageUpload value={formData.banner_image} onChange={url => setFormData({ ...formData, banner_image: url })} label="Masthead Resource" dimensions="1920 x 800" />
                 <p className="help-text mt-4">This asset serves as the primary visual hook for the campaign narrative.</p>
              </div>
           </div>
        </div>
      </div>

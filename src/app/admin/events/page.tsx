    ...
    <div className="space-y-12 animate-in fade-in duration-700">
      ...
      <div className="admin-page-header">
        <div>
          ...
          <p className="admin-page-subtitle mt-1 text-slate-400">Add and manage your holiday packages and events.</p>
        </div>
        <div className="flex items-center gap-3 w-full md:w-auto">
          ...
          <Link href="/admin/events/create" className="admin-btn admin-btn-primary h-11 shrink-0">
                      ...
                      <div className="flex items-center gap-5">
                        ...
                        <div className="min-w-0">
                          ...
                          <div className="text-[9px] font-bold text-slate-400 mt-2 flex items-center gap-2 uppercase tracking-widest leading-none">
                            <MapPin size={10} className="text-red-500" />                              Location: <span className="text-slate-500 font-black">{item.location || 'All Regions'}</span>
                          </div>
                        </div>
                      </div>
                    </td>
        ...
        <div className="admin-form-card bg-slate-900 border-slate-800 p-10 relative overflow-hidden group shadow-2xl">
          ...
          <div className="relative z-10 flex items-center justify-between">
            <div className="flex items-center gap-10">
              ...
              <div>
                <h4 className="text-white font-black text-2xl tracking-tighter uppercase mb-3">Tours Summary</h4>
            ...
            <div className="flex items-center gap-16 pr-12">
              <div className="text-right">
                ...
                <p className="text-[10px] font-bold text-slate-500 uppercase tracking-[0.4em] mt-4 mr-1">Active Tours</p>
              </div>
